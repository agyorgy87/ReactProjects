                ...
                <div className="mt-4">
                    <h3 className="filterTitle">Search By Mobile Service:</h3>
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="checkbox" id="telenor" value="telenor" ref={telenorRef} onChange={phoneServiceFilter}/>
                            <label className="form-check-label" htmlFor="telenor">Telenor ({telenorEmployees})</label>
                        </div>
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="checkbox" id="telekom" value="telekom" ref={telekomRef} onChange={phoneServiceFilter}/>
                            <label className="form-check-label" htmlFor="telekom">Telekom ({telekomEmployees})</label>
                        </div>
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="checkbox" id="vodafone" value="vodafone" ref={vodafoneRef} onChange={phoneServiceFilter}/>
                        ...
                        <div className="mt-3">
                            <h3 className="filterTitle">Search By Rank:</h3>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" id="junior" value="junior" ref={juniorRef} onChange={phoneServiceFilter}/>
                                    <label className="form-check-label" htmlFor="junior">Junior ({juniorEmployees}) </label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" id="medior" value="medior" ref={mediorRef} onChange={phoneServiceFilter}/>
                                    <label className="form-check-label" htmlFor="medior">Medior ({mediorEmployees})</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="checkbox" id="senior" value="senior" ref={seniorRef} onChange={phoneServiceFilter}/>
